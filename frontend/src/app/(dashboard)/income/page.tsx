...
export default function IncomePage() {
  const [tab, setTab] = useState<'revenue' | 'equity'>('revenue');
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white font-heading">Income Journal</h1>
        <p className="text-slate-500 mt-1">Record and manage business inflows (Revenue & Equity)</p>
      </div>
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors ${
              tab === 'revenue' ? 'bg-slate-900 text-white shadow-md' : 'bg-white text-slate-600 hover:bg-slate-50 border border-slate-200'
            }`}
          >
            💰 Revenue
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors ${
              tab === 'equity' ? 'bg-slate-900 text-white shadow-md' : 'bg-white text-slate-600 hover:bg-slate-50 border border-slate-200'
            }`}
          >
            🏛️ Equity/Capital
          </button>
